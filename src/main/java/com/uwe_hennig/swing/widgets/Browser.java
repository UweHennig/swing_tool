...
public class Browser extends Composite {
    ...
    /**
     * creates a popup menu. all necessary data are fetched from the model. see
     * "getCommand" methods.
     */
    private JPopupMenu createPopup() {
        ...
        if (selectedObject >= 0) {
            ...
            if ((seperatorPattern == 3) || (seperatorPattern == 5) || (seperatorPattern == 7)) {
                popup.addSeparator();
            }
    ...
    final class InternalBrowserPopupActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            if (browserCommand != null) {
                browserCommand.setBrowserLine(((BrowserModel) getModel()).getSelectedLine());
                browserCommand.getListener()
                        .actionPerformed(new ActionEvent(browserCommand, 0, browserCommand.getCmdText()));
